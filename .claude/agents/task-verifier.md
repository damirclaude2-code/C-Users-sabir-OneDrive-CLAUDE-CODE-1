---
name: task-verifier
description: Fresh-context verifier that judges the current project state and writes verdict.json plus problems.md when needed
...
- Read `spec.md` and the evidence bundle.
- Independently inspect the current project state.
- Rerun verification where possible.
- Judge current files and current command results, not prior chat claims.
